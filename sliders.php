    ...
    <div class="template">
        ...
        <div class="body">
            ...
            <div class="from-body">
                ...
                <div class="form">
                    <div class="from-btn">
                        <a href="add-slider.php" class="btn btn-warning"><i class="fa-solid fa-plus"></i></a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-btn">
                                                <a href="./edit-slider.php?id=<?php echo $row['id'] ?>" class="btn btn-primary"><i class="fa-solid fa-pen-nib"></i></a>
